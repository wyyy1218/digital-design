...
`define LoongArch32_LU12I_W     8'h05
`define LoongArch32_SLT         8'h06  // Set Less Than (signed)
`define LoongArch32_SLTU        8'h07  // Set Less Than (unsigned)
`define LoongArch32_SLTI        8'h08  // Set Less Than Immediate (signed)

// 2. 逻辑运算
`define LoongArch32_OR          8'h10
`define LoongArch32_ORI         8'h11
`define LoongArch32_ANDI        8'h12
`define LoongArch32_AND         8'h14  // 寄存器-寄存器AND指令
...
`define LoongArch32_B           8'h35  // b offs26: PC=PC+SignExtend({offs26,2'b0},32) (unconditional branch, no return address)
`define LoongArch32_BL          8'h33  // bl offs26: GR[1]=PC+4, PC=PC+SignExtend({offs26,2'b0},32)
`define LoongArch32_JIRL        8'h34  // jirl rd, rj, offs16: GR[rd]=PC+4, PC=GR[rj]+SignExtend({offs16,2'b0},32)
