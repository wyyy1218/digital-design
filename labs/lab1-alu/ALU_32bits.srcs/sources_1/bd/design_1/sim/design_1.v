...
module design_1
  ...
  wire [1:0]ALU_32bits_top_0_led;
  wire [7:0]ALU_32bits_top_0_seg;
  wire [3:0]ALU_32bits_top_0_sel;
  ...
  design_1_ALU_32bits_top_0_0 ALU_32bits_top_0
       (.A(cg_fpga_0_gpio_sw_2),
        .B(cg_fpga_0_gpio_sw_1),
        .btn(cg_fpga_0_btn),
        .led(ALU_32bits_top_0_led),
        .seg(ALU_32bits_top_0_seg),
        .sel(ALU_32bits_top_0_sel),
        .sys_clk(cg_fpga_0_clk_100M),
        .sys_rst_n(cg_fpga_0_btn_rst));
  design_1_cg_fpga_0_0 cg_fpga_0
       (.DDR_addr(DDR_0_addr[14:0]),
        ...
        .rx_0(1'b0),
        .seg_cs(ALU_32bits_top_0_sel),
        .seg_data(ALU_32bits_top_0_seg),
        .vid_active(1'b0),
