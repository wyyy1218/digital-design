...
module design_1
  ...
  wire [31:0]logic_gates_top_0_leds;
  ...
  design_1_cg_fpga_0_0 cg_fpga_0
       (.DDR_addr(DDR_0_addr[14:0]),
        ...
        .btn(cg_fpga_0_btn),
        .gpio_led(logic_gates_top_0_leds),
        ...
        .vid_vblank(1'b0),
        .vid_vsync(1'b0));
  design_1_logic_gates_top_0_0 logic_gates_top_0
       (.btn(cg_fpga_0_btn),
        .leds(logic_gates_top_0_leds));
endmodule
